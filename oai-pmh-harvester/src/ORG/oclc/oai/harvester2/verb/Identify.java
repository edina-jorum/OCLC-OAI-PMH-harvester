...
public class Identify extends HarvesterVerb {
    ...
    /**
     * Added by CG to get the name of the repository being harvested
     * @return
     * @throws TransformerException
     * @throws NoSuchFieldException
     */
    ...
    throws TransformerException, NoSuchFieldException {
        if (SCHEMA_LOCATION_V2_0.equals(getSchemaLocation())) {
            return getSingleString("/oai20:OAI-PMH/oai20:Identify/oai20:repositoryName");
        } else if (SCHEMA_LOCATION_V1_1_IDENTIFY.equals(getSchemaLocation())) {
            return getSingleString("/oai11_Identify:Identify/oai11_Identify:repositoryName");
        } else {
            throw new NoSuchFieldException(getSchemaLocation());
        }
    }
